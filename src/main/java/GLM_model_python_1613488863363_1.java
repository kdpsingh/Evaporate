/*
  ...
  AUTOGENERATED BY H2O at 2021-02-16T10:21:36.813-05:00
  3.32.0.3
  
  Standalone prediction code with sample test data for GLMModel named GLM_model_python_1613488863363_1

  How to download, compile and execute:
      mkdir tmpdir
      cd tmpdir
      curl http://127.0.0.1:54321/3/h2o-genmodel.jar > h2o-genmodel.jar
      curl http://127.0.0.1:54321/3/Models.java/GLM_model_python_1613488863363_1 > GLM_model_python_1613488863363_1.java
      javac -cp h2o-genmodel.jar -J-Xmx2g -J-XX:MaxPermSize=128m GLM_model_python_1613488863363_1.java

     (Note:  Try java argument -XX:+PrintCompilation to show runtime JIT compiler behavior.)
*/
import java.util.Map;

public class GLM_model_python_1613488863363_1 {
  ...
  public static final String[] NAMES = NamesHolder_GLM_model_python_1613488863363_1.VALUES;
  // Number of output classes included in training data response column.
  public static final int NCLASSES = 2;

  // Column domains. The last array contains domain of response column.
  public static final String[][] DOMAINS = new String[][] {
    /* RACE */ GLM_model_python_1613488863363_1_ColInfo_0.VALUES,
    /* AGE */ null,
    /* PSA */ null,
    /* GLEASON */ null,
    /* CAPSULE */ GLM_model_python_1613488863363_1_ColInfo_4.VALUES
  };
  ...
  public String getUUID() { return Long.toString(-2551455267043039524L); }
  ...
  public final double[] score0( double[] data, double[] preds ) {
    ...
    double mu = GenModelEva.GLM_logitInv(eta);
...
class NamesHolder_GLM_model_python_1613488863363_1 implements java.io.Serializable {
  ...
  static {
    NamesHolder_GLM_model_python_1613488863363_1_0.fill(VALUES);
  }
  static final class NamesHolder_GLM_model_python_1613488863363_1_0 implements java.io.Serializable {
...
class GLM_model_python_1613488863363_1_ColInfo_0 implements java.io.Serializable {
  ...
  static {
    GLM_model_python_1613488863363_1_ColInfo_0_0.fill(VALUES);
  }
  static final class GLM_model_python_1613488863363_1_ColInfo_0_0 implements java.io.Serializable {
    static final void fill(String[] sa) {
      sa[0] = "1";
      sa[1] = "2";
    }
...
class GLM_model_python_1613488863363_1_ColInfo_4 implements java.io.Serializable {
  public static final String[] VALUES = new String[2];
  static {
    GLM_model_python_1613488863363_1_ColInfo_4_0.fill(VALUES);
  }
  static final class GLM_model_python_1613488863363_1_ColInfo_4_0 implements java.io.Serializable {
    static final void fill(String[] sa) {
      sa[0] = "0";
      sa[1] = "1";
    }
